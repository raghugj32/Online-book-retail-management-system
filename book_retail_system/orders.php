...
<html class="no-js" lang="en">
  <head>
    ...
    <title>My Orders || Book Retail Store</title>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        ...
        <?php
          ...
          $result = $mysqli->query("SELECT * from orders where customer_id='".$_SESSION["id"]."'");
          if($result) {
            while($obj = $result->fetch_object()) {
              echo '<p><h4>Order ID ->'.$obj->id.'</h4></p>';
              echo '<p><strong>Date of Purchase</strong>: '.$obj->date.'</p>';
              echo '<p><strong>Product Code</strong>: '.$obj->product_id.'</p>';
