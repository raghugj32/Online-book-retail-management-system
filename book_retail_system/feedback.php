...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Feedback || Book Retail Store</title>
  ...
  <body>
    ...
    <form method="POST" action="feedbackupdate.php" style="margin-top:30px;">
      <div class="row">
        <div class="small-8">
          <div class="row">
          <h4>Give your Feedback</h4>
            ...
            <div class="small-4 columns">
              <label for="right-label" class="right inline">Rating</label>
            </div>
            <div class="small-8 columns">
              <input type="range" id="right-label" placeholder="Enter your Rating" name="rating">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label"  value="<?php echo $product_name ?>" disabled >
            </div>
            <div class="small-8 columns" style="visibility: hidden">
              <input type="text" id="right-label"  value="<?php echo $product_id ?>" name="product" >
            </div>
